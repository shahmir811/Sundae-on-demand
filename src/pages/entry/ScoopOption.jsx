...
export default function ScoopOptions({ name, imagePath, optionType, updateItemCount }) {
	...
	return (
		<Col xs={12} sm={6} md={4} lg={3} style={{ textAlign: 'center' }}>
			...
			<Form.Group controlId={`${name}-count`} as={Row} style={{ marginTop: '10px' }}>
				<Form.Label column xs='6' style={{ textAlign: 'right' }} htmlFor={optionType}>
					{name}
				</Form.Label>
				<Col xs='5' style={{ textAlign: 'left' }}>
					<Form.Control type='number' defaultValue={0} onChange={handleChange} isInvalid={!isValid} id={optionType} />
				</Col>
			</Form.Group>
		</Col>
	);
